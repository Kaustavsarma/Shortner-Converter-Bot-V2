...
START_MESSAGE = '''**Hello, {}
I Am shorturllink.in, Bulk Link Converter. I Can Convert Links Directly From Your ShortnerFly Account,
    
1. Go To 👉 https://shorturllin.in/member/tools/api  
2. Than Copy API Key
...
If You Want Any **Other Shortner** Link Converter Bot Instead Of Shorturllink than **contact** at 👉 @new_movies_download_backup (all **shortners** support available.)
'''

HELP_MESSAGE = '''**Hello, {}
I Am shorturllink, Bulk Link Converter Bot. I Can Convert Links Directly From Your ShortnerFly Account,**
    
1. Go To 👉 https://shorturllink.in/member/tools/api  
2. Than **Copy API** Key
3. Than Type **/api** than give a **single space** and than **paste** your **API** Key (**see example** to understand more...)
...
ABOUT_TEXT = '''**Hey! My name is @ShortnerFlyBot. I am Shorturllink Link Converter Bot.**

**⚡Features⚡**

• I can **Convert any** links or posts to your **Shorturllink** link / post. (Button Links Posts, Hidden links/Hyperlinks All Are Supported)
...
START_MESSAGE_REPLY_MARKUP  = InlineKeyboardMarkup([
    [
        InlineKeyboardButton('Get Api', url=f'https://Shorturllink.in/member/tools/api')
    ]
])
...
USER_ABOUT_MESSAGE = """
- Website: [{base_site}](https://shorturllink.in/ref/Jyotirmoydeka)
...
**- Message @masterr07 For More Help -**"""
